  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg my-4">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div>
            <h3 className="font-semibold text-gray-900">Registrar encomienda externa</h3>
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          <Plus size={16} /> Registrar encomienda externa
        </button>
      </div>
        ...
        <div className="text-center py-20 text-gray-400">
          ...
          {tab === 'pendientes' && (
            <button
              ...
              <Plus size={14} /> Registrar encomienda externa
            </button>
          )}
        </div>
      ) : (
